...
<link rel="stylesheet" href="/pain/assets/css/connection.css">
</head>
<body class="sub connection">
	...
	<main id="content">
		...
		<nav class="page-link">
			<div class="container">
				<ul class="nav">
					<li><a href="/pain/connection/speech.php">SRC언어심리상담센터</a></li>
					<li class="active"><a href="/pain/connection/sportscenter.php">SRC스포츠센터</a></li>
				</ul>
			</div>
		</nav>
		    ...
		    <div class="section-content">
		        <div class="container">
		            ...
		            <ul class="row">
		                <li class="col-6">
		                    <figure>
		                        <img src="/pain/assets/images/connection/icon_program01.png" alt="">
		                ...
		                <li class="col-6">
		                    <figure>
		                        <img src="/pain/assets/images/connection/icon_program02.png" alt="">
		...
		<section class="service">
			...
			<div class="section-content">
				<article class="speech">
					...
					<figure>
						<img src="/pain/assets/images/img_speech.png" class="img-fluid" alt="">
					</figure>
				</article>
				<article class="sports">
					...
					<figure>
						<img src="/pain/assets/images/img_sports.png" class="img-fluid" alt="">
					</figure>
				</article>
			</div>
		</section>
