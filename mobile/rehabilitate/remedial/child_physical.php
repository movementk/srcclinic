        ...
        <section class="remedial-common child-physical">
            <div class="container">
                <div class="section-header">
                    <div class="tab-menu">
                        <ul>
                            <li class="active"><a href="/mobile/rehabilitate/remedial/child_physical.php">물리치료</a></li>
                            ...
                            <ul>
                                    ...
                                    <dl>
                                        ...
                                        <dd>
                                            <ol class="circle-list">
                                                <li>뇌성마미, 뇌손상, 척수손상 등의 중추신경계질환으로 인한 발달 장애 아동</li>
                                                <li>근육병, 사경, 염색체이상과 같은 질환의 아동</li>
                                            </ol>
                                        </dd>
                                    </dl>
                                </li>
                                <li>
                                    <dl>
                                        <dt>평가항목</dt>
                                        <dd>
                                            현재 아동이 할 수 있는 능력과 하기 어려운 능력을 판별하고 그에 따른 비정상적 근긴장도 및 움직임의 양상, 그와 연관된 감각 영역의 문제점에 대한 평가가 치료세션마다 이루어집니다. <br>이를 위해 정상 움직임의 발달 즉, 어떻게 발달하고 어떻게 움직이는 것을 배우는지에 대한 연구가 중요합니다. <br> 이러한 평가는 매 치료시마다 이루어지며 그에 따라 치료 또한 달라 질 수 있습니다.
                                        </dd>
                                    </dl>
                                </li>
                                <li>
                                    <dl>
                                        ...
                                        <dd>
                                            <ol class="circle-list">
                                                <li>
                                                    중추신경게 및 근골격계 장애를 가진 아동들의 대상으로 신체 재활치료를 실시하고 있습니다. <br>개별 아동의 신체기능 평가를 통하여 해당 아동의 문제점을 질적으로 연구 분석하고 그에 따라 신경발달적 접근치료법을 사용하기 때문에 매우 효과적입니다
                                                </li>
                                                <li>
                                                    가정 및 기타 내·외적 환경을 고려한 부모 교육도 병행하여 실시함으로써, 아동에 근본적 이해가 가능하며, 그에 따라 문제를 해결해 나가기 때문에 치료 경과도 좋습니다.
                                                </li>
                                                <li>
                                                    1:1 개별치료로 이루어지며, 경험해보지 못했거나 비정상적인 자세와 신체 움직임의 방향을 옳은 방향으로 움직일 수 있도록 도와주어 스스로 움직임을 경험하고 습득할 수 있도록 해줍니다.
                                                </li>
                                            </ol>
                                        </dd>
                                    </dl>
