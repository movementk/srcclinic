                ...
                <div class="article-content">
                    <ul class="row">
                        <li class="col-6">
                            <a href="#">
                                <figure>
                                    <img src="/mobile/rehabilitate/assets/images/notice/img_news_letter01.jpg" class="img-fluid" alt="">
                        ...
                        <li class="col-6">
                            <a href="#">
                                <figure>
                                    <img src="/mobile/rehabilitate/assets/images/notice/img_news_letter02.jpg" class="img-fluid" alt="">
                                    <figcaption>SRC News Letter.36호 (2018년 3월 발행)</figcaption>
                                </figure>
                            </a>
                        </li>
                        <li class="col-6">
                            <a href="#">
                                <figure>
                                    <img src="/mobile/rehabilitate/assets/images/notice/img_news_letter03.jpg" class="img-fluid" alt="">
                                    <figcaption>SRC News Letter.36호 (2018년 3월 발행)</figcaption>
                                </figure>
                            </a>
                        </li>
                        <li class="col-6">
                            <a href="#">
                                <figure>
                                    <img src="/mobile/rehabilitate/assets/images/notice/img_news_letter04.jpg" class="img-fluid" alt="">
                                    <figcaption>SRC News Letter.36호 (2018년 3월 발행)</figcaption>
                                </figure>
                            </a>
                        </li>
