        ...
        <article class="location">
            <div class="container">
                <div class="article-header">
                    <div class="tab-menu">
                        <ul>
                            <li class="active"><a href="/mobile/rehabilitate/introduce/location.php">오시는 길</a></li>
                ...
                <div class="article-content">
                    ...
                    <div class="maps">
                        <figure>
                            <img src="/mobile/rehabilitate/assets/images/introduce/img_maps.jpg" class="img-fluid" alt="지도">
                        </figure>
                    </div>
                </div>
            </div>
