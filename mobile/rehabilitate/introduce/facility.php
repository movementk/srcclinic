...
<body class="introduce">
    ...
    <main id="content">
        ...
        <article class="facility common-facility">
            <div class="container">
                <div class="article-header">
                    <div class="tab-menu facility-tab">
                        <ul>
                            <li class="active"><a href="/mobile/rehabilitate/introduce/facility.php">SRC 부설의원</a></li>
                            <li><a href="/mobile/rehabilitate/introduce/facility_sports.php">SRC스포츠센터</a></li>
