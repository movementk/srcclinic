        ...
        <article class="doctors">
            <div class="article-header">
                <div class="container">
                    <div class="tab-menu">
                        <ul>
                            <li class="active"><a href="/mobile/rehabilitate/introduce/doctors.php">의료진</a></li>
            ...
            <div class="article-content">
                <figure>
                    <img src="/mobile/rehabilitate/assets/images/introduce/img_doctors.png" class="img-fluid" alt="이영상 원장">
                    <figcaption>
                        <h4><small>재활의학과 전문의</small>이영상 원장</h4>
                    </figcaption>
                </figure>
                <div class="container">
                    <ul class="history">
                        <li>
                            <h5 class="sub-title">학력</h5>
                            <ul class="dot-list">
                                <li>연세대학교 의과대학 졸업</li>
                        ...
                        <li>
                            <h5 class="sub-title">학술활동</h5>
                            <ul class="dot-list">
                                <li>독일 근골격의학회 (die Deutsche Gesellschaft fur Musküloskeletale Medizin) 도수의학 Manuelle Medizin/Chirotherapie) 분과 전문의</li>
                                ...
                                <li>독일 근골격의학회 마스터코스 신경역동학과 요통에서시행하는 움직임 조절 검사 (Movement Control for Lower Back Pain and Neurodynamics)</li>
