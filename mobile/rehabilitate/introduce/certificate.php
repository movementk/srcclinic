                    ...
                    <article class="outpatient">
                        ...
                        <ol class="row">
                            <li class="col-6">
                                <div class="icon-img">
                                    <h5>STEP 01</h5>
                                    <img src="/mobile/rehabilitate/assets/images/introduce/icon_outpatient01.jpg" alt="">
                                </div>
                                <p>외래 접수</p>
                            </li>
                            <li class="col-6">
                                <div class="icon-img">
                                    <h5>STEP 02</h5>
                                    <img src="/mobile/rehabilitate/assets/images/introduce/icon_outpatient02.jpg" alt="">
                                </div>
                                <p>주치의 상담</p>
                            </li>
                            <li class="col-6">
                                <div class="icon-img">
                                    <h5>STEP 03</h5>
                                    <img src="/mobile/rehabilitate/assets/images/introduce/icon_outpatient03.jpg" alt="">
                                </div>
                                <p>원무부 발급 신청</p>
                            </li>
                            <li class="col-6">
                                <div class="icon-img">
                                    <h5>STEP 04</h5>
                                    <img src="/mobile/rehabilitate/assets/images/introduce/icon_outpatient04.jpg" alt="">
                                </div>
                                <p>수납 후 발행</p>
                            </li>
                        </ol>
                    ...
                    <article class="inpatient">
                        ...
                        <ol class="row">
                            ...
                            <li class="col-4">
                                <div class="icon-img">
                                    <h5>STEP 03</h5>
                                    <img src="/mobile/rehabilitate/assets/images/introduce/icon_outpatient05.jpg" alt="">
                                </div>
                                <div class="details">
                                    <p>원무부 수령</p>
