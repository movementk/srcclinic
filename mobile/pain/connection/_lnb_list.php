<nav class="lnb-list">
    <div class="dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="lnbMenuButton">
            <a class="dropdown-item" href="/mobile/pain/connection/sportscenter.php">SRC 스포츠 센터</a>
            <a class="dropdown-item" href="/mobile/pain/connection/speech.php">SRC 언어심리상담센터</a>
        </div>
    </div>
</nav>