...
<body class="remedial teenager"> <!-- 폴더명 -->
	...
	<!-- Content -->
	<main id="content" class="teenager-occupational"><!-- 페이지명 -->
		<div class="container">
			<div class="sub-title">
				<h3>청소년작업치료</h3>
				<p>
				...
				<div class="appraisal">
					...
					<div class="details">
						...
						<ol class="circle-list">
							<li><span>1</span>지기능검사(상지의 관절가동범위 및 근력, 잡기, 집기와 같은 기능적 움직임 평가)</li>
							<li><span>2</span>페그보드검사(세밀한 손 동작 및 집기능력과 같은 소근육 기능 평가)</li>
							<li><span>3</span>일상생활동작검사(일상생활활동에 대한 자립도 검사)</li>
							<li><span>4</span>작업치료평가지(수행배경, 수행요소, 지각 및 인지적인 요소 분석)</li>
						</ol>
					</div>
				</div>
				<div class="contents">
					...
					<div class="details">
						<h3>치료내용</h3>
						<ol class="circle-list">
							<li><span>1</span>학습과 관련한 다양한 부분 평가 및 중재 (글쓰기, 읽기, 그리기, 가위질 하기, 계산하기 등)</li>
							<li><span>2</span>대근육 운동기술, 소근육 운동기술, 시지각기능, 인지기능, 연하기능 등 아동 개개인에 맞는 작업수행 및 수행기능 향상을 위한 활동</li>
							<li><span>3</span>과제의 반복 수행을 통하여 수행능력 향상 및 과제 난이도 향상</li>
						</ol>
					</div>
				</div>
			</article>
