		...
		<nav class="intro-tab">
			<div class="container">
				<ul class="menu">
					...
					<li><a href="/rehabilitate/remedial/occupational_therapy.php">작업치료</a></li>
					<li class="on"><a href="/rehabilitate/remedial/sensory_integration.php">감각통합치료</a></li>
	...
	<main id="content" class="child-occupational"><!-- 페이지명 -->
		<div class="container">
			<div class="sub-title">
				<h3>소아 감각통합치료</h3>
				<p>
					감각통합은 자신의 신체와 환경으로부터 주어지는 감각들을 조직화하고 그 환경 속에서 신체를 효과적으로 사용할 수 있도록 하는 신경학적 과정입니다.<br> 이것은 개개인의 능력에 의존하게,중추신경계에서 행동을 조직화하고 계획하기 위해 감각정보를 사용하여 정보처리를 진행하고 통합해가는 것 입니다. 
				</p>
			</div>
			<article class="care">
				<div class="target">
					...
					<div class="details">
						...
						<ol class="circle-list">
							<li><span>1</span>감각정보의 수용과 처리의 어려움으로 인해 정상발달이 어려운 아동(발달장애, 주의력결핍, 과잉행동장애(ADHD)</li>
							<li><span>2</span>학습장애아동</li>
							<li><span>3</span>반응성애착장애아동</li>
							<li><span>4</span>감각통합기능장애아동(각성조절이 어려운 아동, 행동이 더딘 아동)  </li>
						</ol>
					</div>
				</div>
				<div class="appraisal">
				...
				<div class="contents">
					...
					<div class="details">
						...
						<ol class="circle-list">
							<li>
								<span>1</span>감각통합에 어려움이 있는 아동들을 대상으로 가 아동에게 맞는 개별적인 치료프로그램으로 시행되며, 촉각, 진정감각, 고유수용감각,<br> 청각, 시각, 미각, 등 감각자극을 향상시키기 위한 다양한 기회를 제공하고 이를 통해 적응반응을 계획, 조직화하여 의미 있는 활동들을 이끌어 낼 수 있도록 유도함으로써 감각자극을 처리하고 통합하는 중추신경계 능력을 향상시키고자 합니다. 
							</li>
							<li>
								<span>2</span>아동이 스스로 원하는 활동을 하면서 아이가 흥미를 느낄 수 있도록 유도하고, 아동이 적응반응을 보일 수 있도록 활동의 종류와<br> 난이도를 조절하여 제공합니다. 
							</li>
						</ol>
					</div>
				</div>
