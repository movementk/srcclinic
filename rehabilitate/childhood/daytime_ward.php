...
<body class="childhood"> <!-- 폴더명 -->
	...
	<nav class="page-link">
		<div class="container">
			<ul class="nav">
				<li class="active"><a href="/rehabilitate/childhood/daytime_ward.php">낮병동소개</a></li>
				<li>
            ...
            <div class="section-content">
                <div class="container">
                    ...
                    <ol class="row">
                        <li class="col-6">
                            <figure>
                                <img src="/rehabilitate/assets/images/childhood/img_daytime_ward01.jpg" alt="">
                                <figcaption>
                                    <h4><span>1</span> 소아 중심 독립적 치료실</h4>
                                    <p>
                        ...
                        <li class="col-6">
                            <figure>
                                <img src="/rehabilitate/assets/images/childhood/img_daytime_ward02.jpg" alt="">
                                <figcaption>
                                    <h4><span>2</span> 소아 전담 치료진</h4>
                                    <p>
                        ...
                        <li class="col-6">
                            <figure>
                                <img src="/rehabilitate/assets/images/childhood/img_daytime_ward03.jpg" alt="">
                                <figcaption>
                                    <h4><span>3</span> 쾌적하고 위생적인 입원환경</h4>
                                    <p>
                        ...
                        <li class="col-6">
                            <figure>
                                <img src="/rehabilitate/assets/images/childhood/img_daytime_ward04.jpg" alt="">
                                <figcaption>
                                    <h4><span>4</span> 맞춤형 식단</h4>
                                    <p>
                        ...
                        <li class="col-6">
                            <figure>
                                <img src="/rehabilitate/assets/images/childhood/img_daytime_ward05.jpg" alt="">
                                <figcaption>
                                    <h4><span>5</span> ALL IN ONE SERVIES</h4>
                                    <p>
                        ...
                        <li class="col-6">
                            <figure>
                                <img src="/rehabilitate/assets/images/childhood/img_daytime_ward06.jpg" alt="">
                                <figcaption>
                                    <h4><span>6</span> 긴밀한 의료협력</h4>
                                    <p>
