...
<body class="sub connection">
	...
	<main id="content">
		...
		<nav class="page-link">
			<div class="container">
				<ul class="nav">
					<li class="active"><a href="/rehabilitate/connection/speech.php">SRC언어심리상담센터</a></li>
		...
		<section class="speech">
		    <div class="header">
		        <div class="container">
		            <small>종합적 치료서비스를 제공하는 상호협조적 팀 시스템 기관</small>
		            <h2>SRC 언어 · 심리 상담센터</h2>
		        </div>
		    </div>
		    <div class="section-content">
                <div class="container">
                    <ol class="decimal-list">
                        <li>
                            <span>1</span>발달재활치료 바우처 제공기관
                        </li>
                        <li>
                            <span>2</span>특수교육지원대상자 제공
                        </li>
                        <li>
                            <span>3</span>언어발달지원 바우처 제공기관
                        </li>
                        <li>
                            <span>4</span>발당장애인 부모심리상담서비스 제공기관
                        </li>
                    </ol>
                    <div class="row">
                        <div class="col-10 offset-1">
                            <ul class="circle">
                                <li>
                                    <div class="icon-img">
                                        <p>
                                            <img src="/rehabilitate/assets/images/connection/icon_speech01.gif" alt="">
                                        </p>
                                    </div>
                                    <h5>전문가</h5>
                                </li>
                                <li>
                                    <div class="icon-img">
                                        <p>
                                            <img src="/rehabilitate/assets/images/connection/icon_speech02.gif" alt="">
                                        </p>
                                    </div>
                                    <h5>심층적 분석</h5>
                                </li>
                                <li>
                                    <div class="icon-img">
                                        <p>
                                            <img src="/rehabilitate/assets/images/connection/icon_speech03.gif" alt="">
                                        </p>
                                    </div>
                                    <h5>사후평가</h5>
                                </li>
		        ...
		        <figure class="left-img">
		            <img src="/rehabilitate/assets/images/connection/img_left_speech.png" class="img-fluid" alt="">
		        </figure>
		        <figure class="right-img">
		            <img src="/rehabilitate/assets/images/connection/img_right_speech.png" class="img-fluid" alt="">
		        </figure>
		    </div>
