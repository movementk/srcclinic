			...
			<nav class="intro-tab">
				<div class="container">
					<ul class="menu">
						<li><a href="#">물리치료</a></li>
						<li><a href="#">작업치료</a></li>
						<li class="on"><a href="#">감각통합치료</a></li>
						<li><a href="#">언어치료</a></li>
					</ul>
				</div>
			</nav>
		...
		<div class="container">
			...
			<article class="member">
				<ul class="row">
					<li class="col-3">
						<figure>
							<img src="/rehabilitate/assets/images/sub/doctor_list01.png" alt="">
							<figcaption>
								<h3>고 은 별</h3>
								<p>언어치료실 / 언어치료사</p>
							</figcaption>
			...
			<br>
			<br>
			<h2 class="ex-title">전호번호 안내</h2>
			<!-- 전호번호 안내 -->
			<airticle class="number">
				<div class="row">
					<div class="col-6">
						<div class="details">
							<h3 class="center-title">재활 클리닉</h3>
							<ul>
								<li>
									<dl>
										<dt>전화번호</dt>
										<dd>02-871-3651<span>(직통)</span></dd>
									</dl>
								</li>
								<li>
									<dl>
			...
			<br>
			<br>
			<h2 class="ex-title">테이블 type1</h2>
			<!-- table type1 -->
			...
			<br>
			<br>
			<h2 class="ex-title">리스트 type1</h2>
			<!-- list type1 -->
			<ol class="circle-list">
				<li><span>1</span>신청인의 신분증</li>
				<li><span>2</span>가족관계 증명서, 등본 등 친족관계를 확인할 수 있는 서류</li>
				<li>
					<span>3</span>병적증명서 또는 복무확인서
					<p class="attention">의료보험증은 인정안됨</p> 
				</li>
			</ol>
			<br>
			<br>
			<h2 class="ex-title">버튼</h2>
			<!-- 버튼 -->
			<div class="btn-area">
				<p>
			...
			<br>
			<br>
			<h2 class="ex-title">재활 공통</h2>
			<!-- 재활 공통 -->
			<article class="care">
				<div class="target">
					<div class="item">
						<img src="/rehabilitate/assets/images/sub/img_care01.png" alt="">
					</div>
					<div class="details">
						<h3>치료대상</h3>
						<ol class="circle-list">
							<li><span>1</span>뇌성마미, 뇌손상, 척수손상 등의 중추신경계질환으로 인한 발달 장애 아동</li>
							<li><span>2</span>근육병, 사경, 염색체이상과 같은 질환의 아동</li>
						</ol>
					</div>
				</div>
				<div class="appraisal">
					<div class="item">
						<img src="/rehabilitate/assets/images/sub/img_care02.png" alt="">
					</div>
					<div class="details">
						<h3>평가항목</h3>
						<p>
				...
				<div class="contents">
					<div class="item">
						<img src="/rehabilitate/assets/images/sub/img_care03.png" alt="">
					</div>
					<div class="details">
						<h3>치료내용</h3>
						<ol class="circle-list">
							<li>
								<span>1</span>중추신경게 및 근골격계 장애를 가진 아동들의 대상으로 신체 재활치료를 실시하고 있습니다.<br> 개별 아동의 신체기능 평가를 통하여 해당 아동의 문제점을 질적으로 연구 분석하고 그에 따라<br>신경발달적 접근치료법을 사용하기 때문에 매우 효과적입니다
							</li>
							<li>
								<span>2</span>가정 및 기타 내〮외적 환경을 고려한 부모 교육도 병행하여 실시함으로써, 아동에 근본적 이해가 가능하며,<br> 그에 따라 문제를 해결해 나가기 때문에 치료 경과도 좋습니다.
							</li>
							<li>
								<span>3</span>1:1 개별치료로 이루어지며, 경험해보지 못했거나 비정상적인 자세와 신체 움직임의 방향을 옳은 방향으로<br> 움직일 수 있도록 도와주어 스스로 움직임을 경험하고 습득할 수 있도록 해줍니다.
							</li>
						</ol>
					</div>
				</div>
			...
			<article class="board-list">
				<ul>
					<li>
						<a href="#">
							<figure>
								<img src="/rehabilitate/assets/images/sub/ime_board_list01.jpg" alt="">
							</figure>
							<div class="details">
			...
			<br>
			<br>
			<h2 class="ex-title">뉴스 레터</h2>
			<!-- 뉴스 레터 -->
			<div class="news-letter">
				<div class="news-list">
					<a href="#">
						<div class="items">
							<img src="/rehabilitate/assets/images/sub/img_new_letter01.jpg" class="img-fluid" alt="">
						</div>
